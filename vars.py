...
DATABASE_NAME = os.environ.get("DATABASE_NAME", "rupak")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://<rupak:<rupak>@cluster0.cbyim0l.mongodb.net/?appName=Cluster0")  # Add your own atlas db
